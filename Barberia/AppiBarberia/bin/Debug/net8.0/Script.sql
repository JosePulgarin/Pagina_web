...
CREATE TABLE Roles(
	[Id] INT PRIMARY KEY IDENTITY(1,1),
	[Nombre] NVARCHAR(30), -- Administrador, barbero
	[Descripcion] NVARCHAR(MAX), -- Ej: Acceso total del sistema
...
CREATE TABLE Membresias(
	[Id] INT PRIMARY KEY IDENTITY(1,1),
	[NombrePlan] NVARCHAR(40),
	[CostoMensual] DECIMAL(18,2),
	[DescuentoPorcentaje] DECIMAL(18,2),
	[DiaVigencia] INT -- ej: por 30 días
);
...
CREATE TABLE CategoriasProductos(
	[Id] INT PRIMARY KEY IDENTITY(1,1),
	[Nombre] NVARCHAR(40), -- ej: cuidado de barba
	[Descripcion] NVARCHAR(MAX), -- ej:Aceites,bálsamos y peines
	[AplicaImpuesto] BIT DEFAULT 0, -- para saber si cobran iva o algo
...
CREATE TABLE Comisiones(
	[Id] int PRIMARY KEY IDENTITY(1,1),
	[PorcentajeAplicado] DECIMAL(18,2) NOT NULL,
	[Monto] DECIMAL(18,2) NOT NULL,
	[Fecha] DATE NOT NULL,
	[EstadoLiquidacion] NVARCHAR(30) NOT NULL,
...
INSERT INTO Roles (Nombre, Descripcion, Estado, FechaCreacion)
VALUES 
('Administrador', 'Acceso total al sistema, reportes y configuraciones', 1, GETDATE()),
('Barbero', 'Acceso a su agenda, comisiones y portafolio', 1, GETDATE()),
('Recepcionista', 'Manejo de caja, reservas y clientes', 1, GETDATE()),
('Cliente', 'Acceso a su perfil de usuario', 1, GETDATE());


---------------------------------------------------
-- 3. PERFIL USUARIOS
---------------------------------------------------
INSERT INTO PerfilUsuarios (Correo, Contraseña, Estado, IdRol) VALUES 
('admin@barberia.com', 'Admin2026!', 'Activo', 1),
('carlos.barber@mail.com', 'Pass123', 'Activo', 2),
('recepcion.norte@mail.com', 'Recepcion99', 'Activo', 3),
('juan.cliente@mail.com', 'Juanito88', 'Activo', 4),
('mario.barber@mail.com', 'MarioCorte1', 'Activo', 2);
...
---------------------------------------------------
-- 8. BARBEROS (Relacionados con Perfil 2 y 5, Sedes 1-5)
---------------------------------------------------
...
INSERT INTO Membresias (NombrePlan, CostoMensual, DescuentoPorcentaje, DiaVigencia)
VALUES 
('Plan Classic', 30000.00, 5.00, 30),
('VIP Gold', 60000.00, 15.00, 30),
('Black Master', 100000.00, 25.00, 30);

---------------------------------------------------
-- 11. CLIENTES
---------------------------------------------------
INSERT INTO Clientes (Nombre, Telefono, Correo, IdUsuario, IdSede, IdMembresia) VALUES 
('Juan Pérez', '3110001111', 'juanp@mail.com', 4, 1, 1),
('Mateo López', '3110002222', 'mateol@mail.com', 1, 2, 2),
('Sebastian Gil', '3110003333', 'sebas@mail.com', 1, 3, 2),
('Ricardo Arjona', '3110004444', 'ricardo@mail.com', 1, 4, 3),
('Daniel Restrepo', '3110005555', 'danielr@mail.com', 1, 5, 1);

---------------------------------------------------
-- 12 HORARIOS LABORALES
---------------------------------------------------
...
---------------------------------------------------
-- 16. AGENDAS (Citas disponibles para los barberos)
---------------------------------------------------
...
INSERT INTO CategoriasProductos (Nombre, Descripcion, AplicaImpuesto, Estado)
VALUES 
('Cuidado de Barba', 'Aceites, bálsamos, ceras y lociones post-afeitado', 1, 1),
('Cuidado Capilar', 'Shampoos, pomadas, geles y tónicos para el cabello', 1, 1),
('Herramientas', 'Navajas, peines, cepillos y repuestos de máquinas', 0, 1);

---------------------------------------------------
-- 18. PRODUCTOS
---------------------------------------------------
INSERT INTO Productos (MarcaProducto, NombreArticulo, Precio, StockActual, IdInventario, IdProveedor, IdCategoria) VALUES 
('Loreal', 'Cera Mate', 45000.00, 10, 1, 1, 1),
('Wahl', 'Aceite Máquina', 25000.00, 5, 3, 3, 1),
('Gillette', 'Espuma Sensitive', 18000.00, 20, 2, 2, 3),
('Nivea', 'Bálsamo Barba', 32000.00, 8, 4, 4, 1),
('Elegance', 'Gel Extra Strong', 28000.00, 15, 2, 5, 2);
...
(3, 'Se demoraron un poco', '2026-04-12', 'Mucha Espera', 3),
(5, 'Precio justo por la calidad', '2026-04-13', 'Precio Justo', 5);

---------------------------------------------------
-- 21. RESERVAS SERVICIOS
---------------------------------------------------
...
---------------------------------------------------
-- 23. COMISIONES (50% del subtotal aprox)
---------------------------------------------------
...
INSERT INTO Historicos (Usuario, Entidad, Accion, Fecha)
VALUES 
('Admin_Juan', 'Roles', 'Creó los 3 roles iniciales del sistema', GETDATE()),
('Recep_Maria', 'Clientes', 'Registró al cliente Carlos Pérez', GETDATE()),
('Admin_Juan', 'Facturas', 'Anuló la factura #0012 por error en cobro', GETDATE());
...
INSERT INTO Portafolios (Ruta, TituloCorte, Descripcion, IdBarbero)
VALUES 
('https://miservidor.com/img/fade_design1.jpg', 'Mid Fade con Diseño', 'Corte con navaja y diseño en la nuca, uso de pomada mate.', 1),
('https://miservidor.com/img/mullet_pro.jpg', 'Mullet Moderno', 'Corte texturizado a tijera y perfilado de patillas.', 1),
('https://miservidor.com/img/barba_ritual.jpg', 'Ritual de Barba', 'Perfilado con toalla caliente y vapor ozono.', 1);
