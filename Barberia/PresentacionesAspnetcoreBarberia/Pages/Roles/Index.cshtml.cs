...
namespace PresentacionesAspnetcoreBarberia.Pages.Roles
{
    public class IndexModel : PageModel
    {
        ...
        // Usamos nuestra nueva "maleta" de RolModel
        public List<RolesClase> ListaRoles { get; set; } = new List<RolesClase>();        
        // Inyectamos el servicio moderno
        public IndexModel(RolesService RolesService, HistoricosService historicosService)
        {
...
>>>>>>> 112295c9af2e932238842f9f0beda5235c10b042
            ...
            ListaRoles = await _RolesService.ConsultarAsync();
...
>>>>>>> 112295c9af2e932238842f9f0beda5235c10b042
                Accion = "Consultó la lista de Roles",
                Fecha = DateTime.Now
            };
...
>>>>>>> 112295c9af2e932238842f9f0beda5235c10b042
        ...
        {
            // Llama a tu servicio para que borre el Rol con ese ID
            // NOTA: Asegúrate de tener este método EliminarAsync creado en tu RolesService
            var exito = await _RolesService.EliminarAsync(id);
...
<<<<<<< HEAD
        ...
        public async Task<IActionResult> OnGetExportarExcelAsync()
        {
            ...
            var listaDatos = await _RolesService.ConsultarAsync();

            // 2. Creamos el archivo de Excel virtual
            using (var workbook = new XLWorkbook())
            {
                // Nombre de la pestaña abajo en el Excel
                var hoja = workbook.Worksheets.Add("Reporte de Roles");

                // 3. Pintamos los títulos de las columnas (Fila 1)
                // (Ajuste "ColumnaX" por los nombres reales de los atributos de su clase Roles)
                hoja.Cell(1, 1).Value = "ID Rol";
                hoja.Cell(1, 2).Value = "Nombre";
                hoja.Cell(1, 3).Value = "Descripción";
                hoja.Cell(1, 4).Value = "Estado";
                hoja.Cell(1, 5).Value = "Fecha creación";
                ...
                foreach (var item in listaDatos)
                {
                    ...
                    hoja.Cell(fila, 5).Value = item.FechaCreacion;
                ...
                using (var stream = new MemoryStream())
                {
                    ...
                    return File(contenido, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "Reporte_Roles.xlsx");
                }
            }
        }
=======
