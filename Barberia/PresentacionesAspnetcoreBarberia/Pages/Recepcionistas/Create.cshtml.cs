...
namespace PresentacionesAspnetcoreBarberia.Pages.Recepcionistas
{
    public class CreateModel : PageModel
    {
        ...
        public CreateModel(RecepcionistasService RecepcionistasService)
        {
        ...
        public void OnGet()
        {
            // Se ejecuta al abrir la página. Para Recepcionistas suele ir vacío.
        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var exito = await _RecepcionistasService.GuardarAsync(Recepcionista);
            ...
            ModelState.AddModelError(string.Empty, "Error al guardar la Recepcionista.");
            return Page();
        }
    }
}