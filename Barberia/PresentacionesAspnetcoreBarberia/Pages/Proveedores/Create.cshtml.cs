...
namespace PresentacionesAspnetcoreBarberia.Pages.Proveedores
{
    public class CreateModel : PageModel
    {
        ...
        public CreateModel(ProveedoresService ProveedoresService)
        {
        ...
        public void OnGet()
        {
            // Se ejecuta al abrir la página. Para Proveedores suele ir vacío.
        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var exito = await _ProveedoresService.GuardarAsync(Proveedor);
            ...
            ModelState.AddModelError(string.Empty, "Error al guardar la Proveedor.");
            return Page();
        }
    }
}