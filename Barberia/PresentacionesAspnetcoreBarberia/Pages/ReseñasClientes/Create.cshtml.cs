...
namespace PresentacionesAspnetcoreBarberia.Pages.ReseñasClientes
{
    public class CreateModel : PageModel
    {
        ...
        public CreateModel(ReseñasClientesService ReseñasClientesService)
        {
        ...
        public void OnGet()
        {
            // Se ejecuta al abrir la página. Para ReseñasClientes suele ir vacío.
        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var exito = await _ReseñasClientesService.GuardarAsync(ReseñaCliente);
            ...
            ModelState.AddModelError(string.Empty, "Error al guardar la ReseñaCliente.");
            return Page();
        }
    }
}